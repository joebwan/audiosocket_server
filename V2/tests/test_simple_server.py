...
class TestSimpleServer(unittest.TestCase):
    ...
    def test_server_processes_audio_frames_immediately(self):
        ...
        self.assertEqual(server.processed_frames, 1, "Server should process frame immediately")
        client_socket.close()
        server.stop()
        server.close()
    ...
    def test_server_responds_to_client_hangup(self):
        ...
        self.assertFalse(server.is_running, "Server should stop after receiving client hangup")
    ...
    def test_server_handles_protocol_messages_correctly(self):
        ...
        # Test error message
        error_message = AudioSocketProtocol.create_error_message(ErrorCode.HANGUP)
    ...
    def test_server_cleans_up_resources(self):
        ...
        self.assertIsNone(server.client_socket, "Server should clean up client socket")
        self.assertEqual(server.processed_frames, 0, "Server should reset processed frames")
