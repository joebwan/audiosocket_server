...
class TestAudioSocketIntegration(unittest.TestCase):
    """Strict protocol-compliance integration tests for AudioSocket client-server interaction"""
    ...
    def test_protocol_compliance_end_to_end(self):
        """Test end-to-end protocol compliance: connect, UUID, audio, error, hangup"""
